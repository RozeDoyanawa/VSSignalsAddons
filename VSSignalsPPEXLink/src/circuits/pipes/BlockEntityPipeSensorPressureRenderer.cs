...
public class BlockEntityPipeSensorPressureRenderer : IRenderer
{
    private readonly ICoreClientAPI _capi;
    private readonly BlockEntityPipeSensorPressure _beSensor;
    ...
    public BlockEntityPipeSensorPressureRenderer(ICoreClientAPI capi, BlockEntityPipeSensorPressure sensor)
    {
        this._capi = capi;
    ...
    public void OnRenderFrame(float deltaTime, EnumRenderStage stage)
    {
        ...
        int extraGlow = (int)(_beSensor.GetPressure()/_beSensor.GetMaxPressure()*130f);
