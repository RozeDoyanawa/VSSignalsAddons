...
public class BlockEntityTemperatureSensorRenderer : IRenderer {

    private readonly ICoreClientAPI _capi;
    private readonly BlockEntityCowperStoveSensor _beSensor;
    ...
    public BlockEntityTemperatureSensorRenderer(ICoreClientAPI capi, BlockEntityCowperStoveSensor sensor) {
        this._capi = capi;
    ...
    public void OnRenderFrame(float deltaTime, EnumRenderStage stage) {
        ...
        int extraGlow = (int)(_beSensor.GetTemperature() / _beSensor.GetMaxTemperature() * 160f);
